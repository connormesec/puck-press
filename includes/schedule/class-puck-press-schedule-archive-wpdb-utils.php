...
class Puck_Press_Schedule_Archive_Wpdb_Utils extends Puck_Press_Wpdb_Utils_Base
{
    ...
    {
        global $wpdb;
        $wpdb->delete($this->get_full_table_name('pp_schedule_archive_games'),   ['archive_key' => $archive_key]);
        $wpdb->delete($this->get_full_table_name('pp_schedule_archive_sources'),  ['archive_key' => $archive_key]);
        $wpdb->delete($this->get_full_table_name('pp_schedule_archives'),         ['archive_key' => $archive_key]);
    }
}
